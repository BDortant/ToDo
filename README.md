...
- Sidebar counts show open work, with a second outlined badge for how many of those are waiting on the client or a third party; a project where *everything* open is waiting is dimmed
